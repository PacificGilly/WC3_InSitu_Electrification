...
def Surface_Analysis(Date, Radiosonde_Flight_Num):
	...
	for Hour in Product_Hour:
		...
		filename_download = "http://www1.wetter3.de/Archiv/UKMet/" + Date + Hour.rjust(2,'0') + "_UKMet_Analyse.gif"
		filename_save = Storage_Path + Plots_Path + Date + Hour.rjust(2,'0') + "_UKMet_Analyse.png"
