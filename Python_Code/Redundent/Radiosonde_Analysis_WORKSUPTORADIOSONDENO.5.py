...
# Date: 09/08/2018
# Status: Stable
# Change: Added Charge Calibrator function to calibrate the log charge sensor with the linear charge sensor.
############################################################################
...
#Data Set-up Modules
from Data_Aligner import EPCC_Initalise
...
def Radiosonde_Superplotter(Radiosonde_File=None, Calibrate=None, Height_Range=None, Sensor_Package=None, Clouds_ID=None, LayerType=None, Calibration_Log=None):
	...
	if Calibrate == "units": Radiosonde_Cal.cloud_calibration(Sensor_Package, check=1111)
...
if __name__ == "__main__":
	...
	Data = EPCC_Initalise(print_output=False, fromfile=True)
